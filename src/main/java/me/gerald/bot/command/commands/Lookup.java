        ...
        switch (args[1]) {
            case "stats": {
                ...
                if (targetPlayer == null) {
                    ...
                    Util.sendMessage(playerName, args[2] + " Prestige [0] Level [0] XP [0] Balance [0]");
                    return;
                }
            ...
            case "inventory": {
                ...
                if (targetPlayer == null) {
                    Bot.getConfigManager().savePlayer(new Player(playerName, 0, 0, 0, 0, 0, 0));
                    Util.sendMessage(playerName, args[2] + " Diamonds [0] Blocks [0]");
                    return;
                }
                Util.sendMessage(playerName, targetPlayer.getName() + " Diamonds [" + targetPlayer.getDiamonds() + "] Blocks [" + targetPlayer.getBlocks() + "]");
            }
        }
    }
}
